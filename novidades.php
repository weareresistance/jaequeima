        			...
        			<div class="container-fluid">
        				...
        				<div class="collapse navbar-collapse" id="myNavbar">
        					<ul class="nav navbar-nav navbar-right">
        						<li><a class="nav_active" href="novidades.php">NOVIDADES</a></li>
                        ...
                        <div class="container" style="padding:0px; margin:0px; width:100%">
                          ...
                          <div class="container_info">
                            <div class="container bandas">
                                  ...
                                  $query = "SELECT * FROM main WHERE Tipo = 1 OR Tipo =2 ORDER BY Dia";
                                  ...
                                  foreach ($rows as $row){
                                          if ($row['Tipo'] == 1){
                                                 echo '<div class="col-md-4 banda">';
                                                 echo '<div class="bandas_img">';
                                                 echo '<div class="img" style="background-image:url(assets/img/bandas/'.$row["Counter"].'.jpg);"" ></div>';
                                                 echo '</div>';
                                                 echo '<div style="color:rgb('.$colors[$row["Dia"]-$daystart].')" class="bandas_text">';
                                                 echo "<h2>".$row["Info"] ."</h2>";
                                                 echo "<h3>".$row["Dia"] ." de Maio</h3>";
                                                 echo '</div>';
                                                 echo '</div>';
                                         }
